...
// @ts-ignore
import { GetPresentationExamIdResponseDto } from '../model/get-presentation-exam-id-response-dto';
// @ts-ignore
...
export class StudentHttpService {
    ...
    /**
     * Get the presentation exam identifier
     * @param xGuestId 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getPresentationExamId(xGuestId?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<GetPresentationExamIdResponseDto>;
    public getPresentationExamId(xGuestId?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<GetPresentationExamIdResponseDto>>;
    public getPresentationExamId(xGuestId?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<GetPresentationExamIdResponseDto>>;
    public getPresentationExamId(xGuestId?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/student/training/get-presentation-exam-id`;
        return this.httpClient.request<GetPresentationExamIdResponseDto>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
